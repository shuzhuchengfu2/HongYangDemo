...
public class GestureLockViewGroup extends RelativeLayout {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        mNoFingerInnerCircleColor = a.getColor(R.styleable.GestureLockViewGroup_color_no_finger_inner_circle,
                mNoFingerInnerCircleColor);
        mNoFingerOuterCircleColor = a.getColor(R.styleable.GestureLockViewGroup_color_no_finger_outer_circle,
