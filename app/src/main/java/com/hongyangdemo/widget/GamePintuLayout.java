...
import com.hongyangdemo.domain.ImagePiece;
import com.hongyangdemo.utils.ImageSplitter;
...
//
//        mFirst.setImageBitmap(mItemBitmaps.get(getImageIndexByTag(secondTag)).bitmap);
//        mSecond.setImageBitmap(mItemBitmaps.get(getImageIndexByTag(firstTag)).bitmap);
//
...
//        mFirst = mSecond = null;
        ...
        TranslateAnimation animSecond = new TranslateAnimation(0,
                mFirst.getLeft() - mSecond.getLeft(),
