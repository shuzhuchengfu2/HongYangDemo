...
public class ChangeColorIconWithTextView extends View {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        BitmapDrawable drawable = (BitmapDrawable) a.getDrawable(R.styleable.ChangeColorIconView_icon);
        if (drawable != null)
            mIconBitmap = drawable.getBitmap();
        mColor = a.getColor(R.styleable.ChangeColorIconView_color, 0x45C01A);
        mText = a.getString(R.styleable.ChangeColorIconView_text);
        mTextSize = (int) a.getDimension(R.styleable.ChangeColorIconView_text_size, TypedValue
